<template>
  <div>
    <section class="todoapp">
      <header class="header">
        <h1>搞点事情</h1>
        <input class="new-todo" autofocus autocomplete="off" placeholder="临时搞点事情?" v-model="newTodo" @keyup.enter="addTodo">
      </header>
    ...
    <label>完成所有<input  type="checkbox" v-model="allDone"></label>
    <footer class="info">
...
<script>
  ...
  export default { // app initial state
    data() {
      return {
